...
config = {
    ...
    "image": https://upload.wikimedia.org/wikipedia/en/2/27/Bliss_%28Windows_XP%29.png#/media/File:Bliss_(Windows_XP).png, # You can also have a custom image by using a URL argument
